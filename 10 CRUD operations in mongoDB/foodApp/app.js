...
/*
->model.find(): it returns all the document present in the user model
->model.findOne({name:"sonu"}): it returns first only the record which has provided information(case senstive)
->.exec() at the last of the query means this query is done.
->model.findOneAndUpdate(): find the data and update with provided entities.
->model.findOneAndDelete(): find the data and delete that matching data

// process
-> to findout doc we used here getUser() function
-> to post the data we've used postSignUp() function
-> to updating the data we have used updateUser() function
-> to delete the data we have use deleteUser() function
*/